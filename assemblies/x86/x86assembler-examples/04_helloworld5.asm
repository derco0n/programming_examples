...
; assemblieren (32bit) mit:  nasm -f elf ./04_helloworld5.asm
; assemblieren (64bit) mit:  nasm -f elf64 ./04_helloworld5.asm
...
;ld -static -o 04_helloworld5 -e start 04_helloworld5.o 

; #(x86-Binary on x64-System)
;ld -m elf_i386 -static -o 04_helloworld5 -e start 04_helloworld5.o 

; Alles in einem Aufruf (32-Bit-Binary auf 64-Bit System):
; nasm -f elf ./04_helloworld5.asm && ld -m elf_i386 -static -o 04_helloworld5 -e start 04_helloworld5.o && ./04_helloworld5
...
start:
		...
		push esi ; 1. Parameter für Funktion (Auf Konsole schreiben [HEAP-Adresse des auzugebenden Zeichens])
