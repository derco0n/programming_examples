...
sometext db "Hello Bootloader... Dies ist ein sehr langer Text um die Farbiterationen anhand des BX-Registers zu verdeutlichen. xD ... Bei jedem Zeichen wird die Vordergrundfarbe iteriert. Nach jeweils 16 Zeichen wird die Hintergrundfarbe iteriert. Und irgendwann wird das Blink-Flag (Bit 7?) gesetzt... (Dieser Text ist 328 Zeichen lang.)", 0x00
